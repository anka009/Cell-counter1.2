...
# -------------------- Hilfsfunktionen --------------------
def draw_scale_bar(img_disp, scale, length_orig=100, bar_height=30, margin=5, color=(0,0,0)):
    """
...
display_canvas = draw_scale_bar(display_canvas, scale, length_orig=100, bar_height=5, color=(0,0,0))
